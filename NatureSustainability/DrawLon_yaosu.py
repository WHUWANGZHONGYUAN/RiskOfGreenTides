...
for m in range(1, 13):
    ...
    plt.savefig(r"D:\坚果云文件\我的坚果云\Nature_sustainability\Introduction_Analyse\\LON_yaosu"+str(m)+".jpg",dpi=300)
    plt.show()
...
plt.xlabel('Month', fontsize=15)
plt.xticks(x)
plt.savefig(r"D:\坚果云文件\我的坚果云\Nature_sustainability\\LatAnalysis\LON_yaosu_pearson"+str(m)+".svg",dpi=300)
plt.show()