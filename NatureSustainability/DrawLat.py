...
import pandas as pd
import seaborn as sns
dataframe=pd.read_csv("Risk_lat_all.csv")
print(dataframe)
month=['01','02','03','04','05','06','07','08','09','10','11','12']
for m in range(1,13):
    data=dataframe[dataframe['Month']==m]
    sns.lineplot(x='Latitude', y='Risk', data=data,hue='Year', legend=True,palette='Paired')
    ...
    plt.savefig(r"D:\坚果云文件\我的坚果云\Nature_sustainability\LatAnalysis\\LAT"+str(m)+".svg",dpi=300)
    plt.show()
